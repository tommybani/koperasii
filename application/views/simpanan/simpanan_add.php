...
<div class="box box-primary">
  <div class="box-header with-border">
    <h3 class="box-title">FORM TAMBAH DATA SIMPANAN</h3>
  ...
  <div class="box-body">
  	...
  	<div class="col-md-12">
			<form action="<?=base_url('simpanan/add_action')?>" method="POST" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="form-group col-sm-6">
						...
						<select name="anggota_no" id="anggota_no" class="form-control select2" required>
							<option value=""></option>
							<?php
							foreach (ViewAnggota() as $a) { ?>								<option value="<?=$a->anggota_no?>"><?=$a->anggota?></option>
							<?php } ?>
						</select>
					</div>
				...
				<div class="row">
					<div class="form-group col-sm-6">
						...
						<select name="id_jenis" class="form-control jenis" required>
							<option value=""></option>
							<?php
							foreach (ViewJenis() as $j) { ?>								<option value="<?=$j->id_jenis?>"><?=$j->jenis_simpanan?></option>
							<?php } ?>
						</select>
					</div>
				...
				<div class="form-group">
					<a href="<?=base_url('simpanan')?>" class="btn btn-danger btn-md pull-left"><< Kembali</a>
