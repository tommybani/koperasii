<title>Laporan Tunggakan Anggota</title>
...
if($pilih=='anggota'){
	$noanggota = $param;
	$where	= " WHERE b.anggota_no = '$noanggota' AND jumlah_bayar=0";
...
$query = "select a.id_pinjam,a.cicilan,a.angsuran,a.bunga,a.tgl_jatuh_tempo,
      b.anggota_no,
      c.anggota_nama,c.anggota_jk
		from pinjaman_detail as a
		join pinjaman_header as b
		join anggota as c
		ON a.id_pinjam=b.id_pinjam AND b.anggota_no=c.anggota_no
		$where
